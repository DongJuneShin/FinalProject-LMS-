...
public class MessageController {
	...
	public NoteVO detail(@RequestBody Map<String, Object> data) {
		...
		noteVO = msgService.getNote(noteVO, Integer.parseInt(userId));
...
//		log.info("result : " + result);
	...
	@ResponseBody
	@PostMapping("/revList.do")
	public List<NoteVO> revList(@RequestBody String userId) {
...
//		log.info("userId: " + userId);
	...
	@ResponseBody
	@PostMapping("/sendList.do")
	public List<NoteVO> sendList(@RequestBody String userId) {
...
//		log.info("userId: " + userId);
	...
	public List<NoteVO> delList(@RequestBody String userId) {
	...
	public int deleteMsg(String delNum, String userId) {
	...
	public List<NoteVO> selfList(String userId) {
		log.info("노트 삭제 컨트롤러 도착!!");
		log.info("userId : "+ userId);
