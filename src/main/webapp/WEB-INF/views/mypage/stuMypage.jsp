...
<div class="row">
	...
	<div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 col-sm-12">
			<button id="saveBtn" style="margin-left: 170px;"type="button" class="btn btn-primary">저장하기</button>
          </div>
        </div>
      </div>
	</div>
	...
	$("#saveBtn").on("click", function(){
		...
		$.ajax({
			...
			success : function(result) {
				...
				$("#image").val("");
				$("#stuPhoto").val(rseult.stuPhoto);
				$("#stuImg").attr("src", "/resources/upload" + result.stuPhoto);
				$("#smallpp").attr("src", "/resources/upload" + result.stuPhoto);
				$("#stuPn").val(result.stuPn);
				$("#stuEmail").val(rsult.stuEmail);
				$("#password").val(rsult.password);
				$("#stuZip").val(rsult.stuZip);
				$("#stuAddr1").val(rsult.stuAddr1);
				$("#stuAddr2").val(rsult.stuAddr2);
				$("#stuBank").val(rsult.stuBank);
				$("#stuAccount").val(rsult.stuAccount);
				$("#stuAccount").val(rsult.stuAccount);
