			...
			<div class="row g-3">
				<div class="col-md-6">
					<div class="row infoDiv">
						...
						<div class="col-sm-3">
							<input type="text" id="year" class="form-control" value="${teacher.year}" readonly>
						</div>

						<label class="col-sm-2 col-form-label text-sm-end" for="semester">학기</label>
						<div class="col-sm-3">
							<input type="text" id="semester" class="form-control" value="${teacher.clSemester}" readonly>
						</div>
					</div>
				</div>
			...
			<div class="modal-body">
				...
				<input type="hidden" id="clNum" name="clNum">
					<div class="row g-3">
						...
						<div class="col-md-12 text-center">
							<button type="button" id="submit" class="btn btn-primary me-sm-3 me-1">저장</button>
