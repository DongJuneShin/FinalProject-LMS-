			...
			success : function(result){
				...
				ques.push(result.getRatioLecture[20].lelContent);
				 ...
				 for(var i=0; i<result.getRatioLecture.length; i++){
					...
					str+=		"<div class='col-md-6'>"+result.getRatioLecture[i].count+"명   "+(parseInt(result.getRatioLecture[i].count)/parseInt(checkPeople))*100+"%</div>";
					str+=	"</div>";
					str+=	"<br>";
					str+="</div>";
				}
		...
		<div class="modal-content p-3 p-md-5">
			<div class="modal-body">
				...
				<div class="text-left mb-4">
					<h3 style="display: inline-block;">강의평가(참여인원 : <span id="checkPeople"></span>)</h3>
				</div>
				<hr />
				 <div class="row g-1">
				 	<div class="row modal-row" id="append">
