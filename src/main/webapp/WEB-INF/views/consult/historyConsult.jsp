					...
					<tr>
						...
						<c:choose>
							<c:when test="${consultMap.CR_CHECK == 0 }">
								<td>대기</td>
								<td>
									<button type="button" class="btn btn-sm btn-danger btnDelete" id="${consultMap.CR_NUM }">신청 취소</button>
								</td>
							</c:when>
							<c:when test="${consultMap.CR_CHECK == 1 }">
								...
								<td>
									<c:if test="${consultMap.CR_TYPE == 1 }">
										<button type="button" class="btn btn-sm btn-primary btnVideo" id="${consultMap.TEA_NUM }">
							...
							<c:otherwise>
								<td>반려</td>
								<td>
									<button type="button" class="btn btn-sm btn-secondary btnCrComre" id="${consultMap.CR_NUM}" 
