			...
			<tbody>
				<c:forEach var="consultMap" items="${consultMapList}" varStatus="stat">
					<tr>
						...
						<td>
							<button type="button" class="btn btn-sm btn-primary btnOk" id="${consultMap.CR_NUM }">승인</button>&nbsp;/
							<button type="button" class="btn btn-sm btn-danger btnComreModal" id="${consultMap.CR_NUM }"
