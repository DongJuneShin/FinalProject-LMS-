			...
			<div class="col-lg-8 mx-auto">
				...
				<br /><br />
	              ...
	              <div class="col-md-12">
	                ...
	                <a href="/downloadFile?fileName=${dfVO.dfNm}" type="button" class="btn btn-xs btn-dark">다운로드</a>
	              </div>
	              </c:forEach>
	              <hr />
	              ...
	              <div class="col-md-2">
	              <a style="margin-left: 55px;" href="/dpNotieBoard/dpNoticeBoardList" class="btn btn-sm btn-secondary">목록보기</a>
	              </div>
				  </c:if>
				  <c:if test="${data.teaNum == username}">
	              <div class="col-md-9">
	              ...
	              <div class="col-md-3">
	              <a href="/dpNotieBoard/update?dnNum=${data.dnNum}" style="margin-left: 55px;" class="btn btn-sm btn-warning">수정하기</a>
