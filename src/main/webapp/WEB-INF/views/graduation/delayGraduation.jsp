...
// 				alert("다녀옴!");
				console.log("result.GP_CHECK : " + result.GP_CHECK);
				console.log("result.GP_COMRE : " + result.GP_COMRE);

// 				let v_gpComre = result.GP_COMRE;
...
// 					alert("승인 대기 중인 졸업유예 신청내역이 존재합니다.");
// 					return false;
