...
<%-- 										<td style="display: none;">${paymentsList.srSemester}</td> --%>
										...
										<td>
											<a class="sreYn" data-stunum="${paymentNum.stuNum}">
...
$(function() {
 ...
 var lang_eng = {
	...
	$(".showSreYn").on("click",function(){
		...
		console.log("flexRadioDefault1, flexRadioDefault2 : " + flexRadioDefault1,flexRadioDefault2);
		...
		$.ajax({
	         ...
	         success : function(result){
	        	 slNum = result.ScholarshipListVO.slNum;
		       	  ...
		       	  console.log(result.ScholarshipListVO.sreYn);
