        		...
        		<div class="row text-center">
        			...
        			<div class="col-md-4  text-center">
        				<p style="font-size: 1.1em; font-weight: bold;">
        					<i class='bx bxs-cube'></i>
        					장학생 추천 현황</p>
        				<a href="/scholarship/recommendation" type="button" class="btn btn-xs btn-outline-secondary">조회하기</a>
        			</div>
        		</div>
        		<br/>
        		<div class="row text-center">
        			<div class="col-md-6">
        				<p style="font-size: 1.1em; font-weight: bold;">
        					...
        					강의개설 신청 현황</p>
        				<a href="/enroll/application" type="button" class="btn btn-xs btn-outline-secondary">조회하기</a>
        			</div>
        			<div class="col-md-6">
        				<p style="font-size: 1.1em; font-weight: bold;">
	        				<i class='bx bxs-food-menu' ></i>
        					강의평가 현황</p>
        				<a href="/le/leCheck" type="button" class="btn btn-xs btn-outline-secondary">조회하기</a>
        			</div>
        		</div>
			</div>
		</div>
