...
$(function(){
	...
	$("#submit").on("click",function(){
		...
		if((attscore) >20){
			alert("출석점수는 20점이 넘을수 없습니다.");
			return false;
		}
		if((mtest) >30){
			alert("중간점수는 30점이 넘을수 없습니다.");
			return false;
		}
		if((ftest) >30){
			alert("기말점수는 30점이 넘을수 없습니다.");
			return false;
		}
		if((hw) >30){
			alert("기타점수는 20점이 넘을수 없습니다.");
			return false;
		}
