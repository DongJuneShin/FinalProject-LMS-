	...
	<div class="card body">
		<ul class="nav nav-pills flex-column flex-md-row mb-3" style="text-align: center;">
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="1" >1월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="2" >2월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="3" >3월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="4" >4월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="5" >5월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="6" >6월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="7" >7월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="8" >8월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="9" >9월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="10" >10월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="11" >11월</button>
		      </li>
		      <li class="nav-item months">
		      	<button type="button" class="nav-link a_month" id="12" >12월</button>
		      </li>
		</ul>
	</div>
	</div>
