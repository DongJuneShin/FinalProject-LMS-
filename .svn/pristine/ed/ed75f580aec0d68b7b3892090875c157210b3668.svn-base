...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		ws.onmessage = function(event) {
			console.log("onmessage의 event의 값 : " + event.data);
		...
		$("#submitt").on("click",function(){
			...
			$.ajax({
				...
				success : function(result){
					alert("수강신청 "+result.count+"개의 과목이 정상적으로 추가되었습니다.");
		...
		$("#moreButton").on("click",function(){
			//alert("colleage : "+colleage + " , department : "+department);
...
//								let result = item.roomLect+"<br>"+item.sbjTitle + "<br>" + item.teaNmKor+"<br>";
		...
		$(document).on("click",".minus",function(){
					...
					console.log($("#" + timeCode3).css("background-color"));
					console.log($("#" + timeCode3).css("background-color"));
					console.log($("#" + timeCode3).css("background-color"));
					...
					console.log("마이너스 된 값 : " + currentData);
		...
		function writeResponse(text) {
			...
			console.log("writeResponse의 text의 값 : " + text);
								...
								<div class="col-sm-12 col-md-12">
									<div class="dataTables_length" id="dataTable_length" >
										...
										<div style="float:right;">
											<button type="button" id="back" style="padding-top: 1.5px; height: calc(1.8125rem + 2px);" class="btn btn-block btn-default">뒤로가기</button>
										</div>
										<div style="float:right;">
											<button type="button" id="submitt" style="padding-top: 1.5px; height: calc(1.8125rem + 2px);" class="btn btn-block btn-default">완료</button>
										</div>
									</div>
								</div>
